...
def setup_config():
    ...
    cfg.TEST.EVAL_METRICS = ["classwise_dice_score", "argmax_dice_score", "overlap"]  # metrics which get computed during eval
    ...
    cfg.DATASET.crop_size = (140, 140)  # size of centre crop
